...
const useApperance = () : Props => {
    const [currentTheme, setCurrentTheme ] = useState<themeTypes>(Appearance.getColorScheme() || 'light',
    );

    const handleChangeAppeareance = useCallback(({colorScheme}: colorSchemeProps) => {
       if(colorScheme){
